...
router.patch("/:id", async (req, res) => {
    try {
        ...
        const { first_name, last_name, full_name, email_primary, email_secondary, phone_primary, phone_secondary, shipping_address, billing_address, customer_notes, } = req.body || {};
        const updatePayload = {
            updated_at: new Date().toISOString(),
        };
        const setString = (key, value, maxLen) => {
            if (value === undefined)
                return;
            if (value === null) {
